...
We can't use babel in production. That requires to make small change to.
...
Error: Missing required flag:
 ...
 Try to run: heroku config:set PRISMA_ENDPOINT=https://us1.prisma.sh/krystyna-2fc50b/food/prod PRISMA_SECRET=thinkpositivesecret PR
ISMA_MANAGEMENT_API_SECRET=ce624c07c97ee6a -a pure-everglades-49013
